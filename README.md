...
- ✍️ [Gesttalt](https://github.com/pepicrft/gesttalt) ([Mozilla Public License 2.0](https://github.com/pepicrft/gesttalt/blob/main/LICENSE.md)) - An open-source publishing platform designed for agents to run complete blogs while people keep ownership and approval.
